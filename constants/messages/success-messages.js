export const RESERVATION_EMAIL =
  "Zahvaljujem Vam se na rezervaciji! Molim Vas da pokušate doći par minuta prije samog termina. U slučaju da budete spriječeni doći, molim Vas da otkažete Vaš termin na broj telefona +38765184670 ili na email bojanagolubovic.makeup@gmail.com. Za sve dodatne informacije možete me kontaktirati. Vidimo se! ";
...
export const GIFT_CARD_EMAIL =
  " Molim Vas da poklon bon ili odštampate ili proslijedite na email adresu osobe kojoj poklanjate. Osoba kojoj poklanjate, treba da rezerviše svoj termin na neki od kontakata sa poklon bona. Poklon bon je potrebno ponijeti sa sobom na dan termina.";
export const GIFT_CARD_IMPORTANT_NOTE =
